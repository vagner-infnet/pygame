...
def exibe_janela_e_desenha_2formas_com_teclas():
    ...
    def forma_1(contador):
        ...
        PAINEL_1.blit(text, (distancia_da_esq_para_a_dir_do_TEXTO_1, distancia_de_cima_para_baixo_do_TEXTO_1))
    def forma_2(contador):
        ...
        #inserindo o texto-imagem no painel
        PAINEL_1.blit(text, (distancia_da_esq_para_a_dir_do_TEXTO_2, distancia_de_cima_para_baixo_do_TEXTO_2))
        ####################################################
